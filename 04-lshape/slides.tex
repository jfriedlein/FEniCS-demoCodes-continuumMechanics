...
%   \draw (0.05, 1.5) -- +(2.9, 0);
  ...
  \onslide<2-3>{\node at(0.5,0.5) {\includegraphics[width=3.5cm]{../04-lshape/stress11.png}};}
  \onslide<4-5>{\node at(0.5,0.5) {\includegraphics[width=3.5cm]{../04-lshape/stress22.png}};}
  \onslide<6-7>{\node at(0.5,0.5) {\includegraphics[width=3.5cm]{../04-lshape/stress12.png}};}
%     \draw (0, 0) -- (1, 0) node[above left, black]{$\mathcal{B}$} -- (1, 0.5) -- (0.5, 0.5) -- (0.5, 1.0) -- (0, 1.0) -- cycle;
  \begin{scope}[xshift=2.0cm,yshift=1.0cm,scale=0.3]
   \onslide<2-3>{\begin{axis}[verticalbar,point meta min=-4.2,point meta max=47.1,title={$\sigma_{11}$ in $\mathrm{MPa}$}] 
    \addplot [draw=none] coordinates {(0,0)}; \end{axis}}
   \onslide<4-5>{\begin{axis}[verticalbar,point meta min=-4.2,point meta max=47.1,title={$\sigma_{22}$ in $\mathrm{MPa}$}] 
    \addplot [draw=none] coordinates {(0,0)}; \end{axis}}
   \onslide<6-7>{\begin{axis}[verticalbar,point meta min=-23.0,point meta max=3.0,title={$\sigma_{12}$ in $\mathrm{MPa}$}] 
    \addplot [draw=none] coordinates {(0,0)}; \end{axis}}
  \end{scope}

  \begin{scope}[xshift=1.6cm,yshift=0.8cm]
   \clip (0,0) circle (0.4);
  \onslide<3>{\node at (0,0) {\includegraphics[width=6.0cm]{../04-lshape/magnified11.png}};}
  \onslide<5>{\node at (0,0) {\includegraphics[width=6.0cm]{../04-lshape/magnified22.png}};}
  \onslide<7>{\node at (0,0) {\includegraphics[width=6.0cm]{../04-lshape/magnified12.png}};}
  \end{scope}
  \onslide<3,5,7>{
...
%   \draw (1.5,0.8) rectangle +(0.6,0.6);
  ...
  \begin{scope}
  \onslide<3>{\node at (0.5,-0.5) {\includegraphics[width=3.9cm]{../04-lshape/curve11.png}};}
  \onslide<5>{\node at (0.5,-0.5) {\includegraphics[width=3.9cm]{../04-lshape/curve22.png}};}
  \onslide<7>{\node at (0.5,-0.5) {\includegraphics[width=3.9cm]{../04-lshape/curve12.png}};}
  \end{scope}
