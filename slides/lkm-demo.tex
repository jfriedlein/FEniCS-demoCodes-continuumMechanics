...
%   \draw (0.05, 1.5) -- node[above]{$10 \,\mathrm{MPa}$} +(2.9, 0);
  ...
  \onslide<2>{
  \node at(1.5,0.55) {\includegraphics[width=6cm]{../03-thermo-elasto-static/01-sunshine/theta.png}};
  \begin{scope}[xshift=3.5cm,yshift=1.3cm,scale=0.5]
  ...
  \onslide<3>{
  \node at(1.5,0.55) {\includegraphics[width=6cm]{../03-thermo-elasto-static/01-sunshine/stress.png}};
  \begin{scope}[xshift=3.5cm,yshift=1.3cm,scale=0.5]
...
%   }
  ...
  \onslide<2>{
  \node at(2,-0.15) {\includegraphics[width=8cm]{../03-thermo-elasto-static/02-bimetal/stress.png}};
...
%   \fill[gray] (3.0, 0.0) rectangle +(0.05, 1.0);
  ...
  \onslide<1>{
   ...
   \node at (1.5, 0.3) {$\alpha_1$};
   \node at (1.5, 0.1) {$\alpha_2$};  
 }
...
% 							 $q^p_\text{bottom} = -10 \, \frac{\mathrm{kW}}{\mathrm{m}^2}$}};}
  ...
  \onslide<1>{
   \node at(4.5,-1.3) {\includegraphics[width=3cm]{thermometer.jpg}};
