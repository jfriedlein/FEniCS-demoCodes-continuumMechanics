...
\begin{frame}{}
 \frametitle{Demo 7-1 $\vert$ \bfseries Thermo-elasticity -- Video}
 \framesubtitle{\bfseries bimetallic thermometer}
  \href{../videos/lkm-demo-7-1-thermometer.avi}{
    \includegraphics[scale=.3]{../videos/lkm-demo-7-1-thermometer.png}
  }
\end{frame}
...
%   \onslide<2-4>{\node at (0, -0.4) [right,font=\footnotesize]{$\v u$ scaled with a factor of $1000$};}
  ...
  \onslide<1>{
   \begin{axis}[xshift=3.4cm, yshift=-4.2cm, height=3cm, width=5cm, font=\footnotesize, 
    axis y line=left, axis x line=bottom, xlabel=$t$, ylabel=$t^p_1$, 
...
\begin{frame}{}
 \frametitle{Demo 7-2 $\vert$ \bfseries Thermo-elasticity -- Video 1/2}
 \framesubtitle{\bfseries Gough-Joule effect}
  \href{../videos/lkm-demo-7-2a-stress.avi}{
    \includegraphics[scale=.3]{../videos/lkm-demo-7-2a-stress.png}
  }
\end{frame}


\begin{frame}{}
 \frametitle{Demo 7-2 $\vert$ \bfseries Thermo-elasticity -- Video 2/2}
 \framesubtitle{\bfseries Gough-Joule effect}
  \href{../videos/lkm-demo-7-2b-temp.avi}{
    \includegraphics[scale=.3]{../videos/lkm-demo-7-2b-temp.png}
  }
\end{frame}
